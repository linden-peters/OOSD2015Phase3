/*
 * GetCustomerJSON.java - Customer JSON Servlet
...
/**
 * Servlet implementation class GetCustomerJSON
 */
@WebServlet("/GetCustomerJSON")
public class GetCustomerJSON extends HttpServlet {
